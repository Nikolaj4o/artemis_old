...
use std::{
    cell::RefCell, default, ops::{RangeInclusive, Shl}
};
...
#[test]
fn test_round_trip() {
    use crate::halo2curves::{ff::Field, pasta::Fp};
    use num_bigint::RandomBits;
    use rand_core::{OsRng, RngCore};

    for _ in 0..1000 {
        let a: big_uint = big_uint::default();//OsRng.sample(RandomBits::new(256));
...
fn test_bit_decomposition() {
    ...
    let e_0: big_uint = big_uint::default();//OsRng.sample(RandomBits::new(bit_size as u64));
